...
class SecondMiniPlayer extends StatefulWidget {
  int index;
  List<Audio> audiosongs = [];

  SecondMiniPlayer({Key? key, required this.index, required this.audiosongs})
      : super(key: key);

  @override
  State<SecondMiniPlayer> createState() => _SecondMiniPlayerState();
}

class _SecondMiniPlayerState extends State<SecondMiniPlayer> {
